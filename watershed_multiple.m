function watershed_multiple(img_color,img_gray,img_binary,originalname,ext,row,col,outputdir)
% img_color: RGB image
% f: graylevel image
...
%TIME%img_dilate=bwmorph(img_binary,'dilate',2);
%TIME%img_dilate=~img_dilate;
...
DL=watershed(D);
bgm=DL==0;
%TIME%markers=imimposemin(f,bgm|img_erode);
